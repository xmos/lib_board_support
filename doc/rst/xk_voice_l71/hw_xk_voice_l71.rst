...
The API included supports the following features:
 ...
 - Setting up of the DAC for either 16 kHz or 48 kHz. The DAC is configured as I2S slave.
 - The DAC may be configured to accept data from either I2S_IN or I2S_OUT signals on the board.
 - Setting up of the Application PLL to drive an master clock at 12.288 MHz, 24.576 MHz or 49.152 MHz. Alternatively, it
 ...
 - Setting up of the I2C expander which controls signal connection to the Raspberry Pi style header, allowing connection to
   external systems. MCLK, I2S, SPI and INT connections may be indivually enabled or disabled.
