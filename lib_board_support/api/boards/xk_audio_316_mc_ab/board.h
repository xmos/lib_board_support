...
/**
 * @brief Type of MCLK to be generated.
 *
 * This may be:
 *   - a fixed clock generated using the secondary PLL,
 *   - an adjustable clock generated by the external CS2100 PLL,
 *   - an adjustable clock generated using the secondary PLL, or
 *   - no clock generated.
 */
typedef enum {
    CLK_FIXED,
